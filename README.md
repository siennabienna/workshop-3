...
- Another idea for a sketch - draw some kind of computer using primitive shapes, and then draw a bunch of little bugs. Code the little bugs to move around ontop of the computer screen drawing at a certain speed. Create a function that would allow the user to click on a bug and it will disappear - de-bug sketch
